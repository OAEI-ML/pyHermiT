...
class CancellationHandle:
    ...
    @property
    def _debug_poll_count(self) -> int: ...
...
class NativeSession:
    ...
    def _encoded_service_symbols_v1(self) -> _NativeServiceSymbols: ...
    def _hierarchy_result_v1(self, domain: str) -> _NativeHierarchyResult: ...
    def _realization_result_v1(self) -> _NativeRealizationResult: ...
...
class _NativeRealizationResult:
    ...
    def matches(self, symbols: _NativeServiceSymbols, domain: str) -> bool: ...
    def matches_hierarchy(self, hierarchy: _NativeHierarchyResult) -> bool: ...
